...
export default class FieldLine implements WorldObject {
    ...
    constructor(position: AbstractVector = new Vector(0, 0), da: number = 0.01, ds: number = 3, width: number = 0.25, color: Color = "#000000ff", z_index: number = 1, max_iterations: number = 1000) {
